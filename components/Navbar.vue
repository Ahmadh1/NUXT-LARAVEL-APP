<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
      <div class="container">
        <nuxt-link to="/" class="navbar-brand">NUXT-LARA</nuxt-link>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <nuxt-link to="/topics" class="nav-link">Posts</nuxt-link>
            </li>
          </ul>
          ...
          <template v-else="authenticated">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <nuxt-link to="/dashboard" class="nav-link">{{ user.name }}</nuxt-link>
                </li>
              <li class="nav-item">
